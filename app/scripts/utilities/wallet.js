angular.module('paysharesClient').factory('Wallet', function($q, $http, ipCookie) {
  ...
  /**
   * The Wallet class provides functionality for interacting with the payshares-wallet
  ...
  var Wallet = function(options){
    ...
    if (this.version === 2) {
      // This is Wallet object from payshares-wallet-js-sdk:
      // https://github.com/payshares/payshares-wallet-js-sdk#wallet-object
      this.walletV2 = options.walletV2;
      if (_.isPlainObject(this.walletV2)) {
        // Deserialize object
        this.walletV2 = PaysharesWallet.createFromData(this.walletV2);
      }
    ...
    if(this.mainData.payshares_contact) {
      delete this.mainData.payshares_contact;
    }
  };
  ...
  Wallet.decrypt = function(encryptedWallet, id, key){
    ...
    try {
      ...
      // https://github.com/payshares/payshares-client/issues/566
      mainData = {};
    }
  ...
  Wallet.prototype.sync = function(action) {
    if (this.version === 2) {
      if (action === 'update') {
        ...
        // Done using payshares-wallet-js-sdk in registration-controller.js
      }
    } else {
   ...
   * https://github.com/payshares/payshares-client/issues/594
   */
   ...
   * https://github.com/payshares/payshares-client/issues/576
   */
  function enforceCorrectAddress(wallet) {
    ...
    var seed = payshares.Seed.from_json(signingKeys.secret);
